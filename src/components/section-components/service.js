			    ...
			    <div className="row justify-content-center">
			      <div className="col-lg-4 col-md-10">
			        <div className="single-service-wrap">
			          ...
			          <div className="single-service-details">
			            <h4><a href="property-details.html">Book Space & Property</a></h4>
			      ...
			      <div className="col-lg-4 col-md-10">
			        <div className="single-service-wrap">
			          ...
			          <div className="single-service-details">
			            <h4><a href="property-details.html">Apartment</a></h4>
			      ...
			      <div className="col-lg-4 col-md-10">
			        <div className="single-service-wrap mb-0">
			          ...
			          <div className="single-service-details">
			            <h4><a href="property-details.html">Creative Space</a></h4>
